...
- One–liner: this is the same as the first Compound Components, but uses Context
  instead of passing down props
- Use this way when we are not just dealing with direct descendents, but want to
  pass state down to grandhildren
- If just passing down to direct descendents, use the cloneElement way, as in
  the previous exercise
- KCD didn't mention any performance concerns in relation to using Context
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=Advanced%20React%20Patterns%20%F0%9F%A4%AF&e=03%3A%20Flexible%20Compound%20Components&em=alexblyth%40pm.me).
