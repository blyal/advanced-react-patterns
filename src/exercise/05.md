...
- For in case single–case customizable actions need to happen during state
  changes in hooks and reusable components.
- Basically useReducer in a reusable component.
- N.B. !Use an enum or object instead of strings in a reducer!
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=Advanced%20React%20Patterns%20%F0%9F%A4%AF&e=05%3A%20State%20Reducer&em=alexblyth%40pm.me).
