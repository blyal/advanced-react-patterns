...
- Prop Collections and Prop Getters are ways to pass down collections of props
- Prop Collections is more strict / static (it's an object) so not easy to
  override, for example, an onClick
- ...which is where Prop Getters (which are functions) come into play
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=Advanced%20React%20Patterns%20%F0%9F%A4%AF&e=04%3A%20Prop%20Collections%20and%20Getters&em=alexblyth%40pm.me).
